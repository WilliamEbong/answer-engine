...
1. "fidelity" — factual fidelity to the briefing: every claim traces to the briefing; figures quoted exactly; no outside facts; no strengthened or over-generalized claims. Hunt specifically for: causal or mechanistic explanations the briefing does not give (telltale words: "because", "likely", "probably", "due to", "suggesting that"), superlatives or comparatives the briefing does not itself make ("largest", "most", "hardest"), and characterizations that exceed the briefing's own wording. Pay special attention to sentences that JOIN two briefing facts — the connective ("but", "which meant", "took more X to do Y") often asserts an unsupported mechanism even when both joined facts are supported; split such sentences into separate plain restatements. Rewrite or DELETE every offending sentence — the downstream gatekeeper rejects the whole level over a single one.
